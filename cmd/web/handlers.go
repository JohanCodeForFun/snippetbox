...
import (
	...
	"snippetbox.jhellberg.com/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	// the second, we "check that the form.Title field has a maximum character // length of 100" and so on.
	...
	app.logger.Info("create post", "title", form.Title, "content", form.Content)
